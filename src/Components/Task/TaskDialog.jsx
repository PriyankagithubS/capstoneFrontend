...
const [duplicateTask]=useDuplicateTaskMutation();
    ...
    const duplicateHandler = async () => {
        ...
        const taskId = task._id.toString(); // Convert the ID to a string
        console.log("Task ID:", taskId); // Log to verify

        try {
            const res = await duplicateTask(taskId).unwrap(); // Pass taskId directly as a string
    ...
    const deleteHandler = async () => {
        ...
        try {
            const res = await deleteTask(task._id).unwrap(); // Passing only the ID as the mutation expects
            toast.success(res?.message);
            setTimeout(() => {
            ...
            console.error("Error:", err);
            toast.error(err?.data?.message || err.error || "Failed to delete the task.");
        }
    };
